"""
Research agent implementation using the deep agents framework.
Specialized for academic research, data analysis, and scientific investigation.
"""
...
def create_research_agent():
    """Create and configure the research-specialized deep agent."""
    ...
    # Create the research deep agent with full research tools (subagent tool issue fixed)
    agent = create_deep_agent(
        tools=[
            # Perplexity research tools (now working)
            perplexity_reasoning_search,
            perplexity_focused_research,
            # Advanced research strategy tools
            academic_search,
            technical_search,
            deep_research,
        ...
        ] + core_research_subagents,  # All CORE research subagents included
        model=model,
        checkpointer=checkpointer,
        # Configure human-in-the-loop for the highest-cost research tool
        interrupt_config={
            "sonar_deep_research": {
                "allow_ignore": False,
                "allow_respond": True,
